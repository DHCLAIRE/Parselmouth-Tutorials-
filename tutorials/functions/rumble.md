...
| --- | --- | --- | --- |
| `Frequency (0-1000 Hz)` | `real` | `120` | `frequency` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "rumble.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 120, 1)
