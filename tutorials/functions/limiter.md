...
| --- | --- | --- | --- |
| `Threshold (dB)` | `real` | `80` | `threshold` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "limiter.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 80, 1)
