...
- Praat source: `changesemitones.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `changesemitones.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
| --- | --- | --- | --- |
| `Semitones (-24 to +24)` | `real` | `12` | `semitones` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "changesemitones.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 12, 1)
