...
| --- | --- | --- | --- |
| `Filter` | `choice` | `1; options: High-pass, Low-pass` | `filter` |
| `Frequency (Hz)` | `positive` | `1000` | `frequency` |
| `Filter order` | `natural` | `2` | `filter_order` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "butterworth.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 1, 1000, 2, 1)
