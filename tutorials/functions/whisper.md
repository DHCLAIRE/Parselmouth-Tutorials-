...
SCRIPT = os.path.join(TOOLKIT_DIR, "whisper.praat")
...
result = run_toolkit_script("whisper.praat", "voice.wav")
```
...
- This script calls or includes: `batch.praat`, `declip.praat`, `eq10bands.praat`, `fixdc.praat`, `gate.praat`, `workpost.praat`, `workpre.praat`.
