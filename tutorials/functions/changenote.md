...
| --- | --- | --- | --- |
| `New note` | `optionmenu` | `1; options: C	Do, C#	Do sharp, D	Re, D#	Re sharp, E	Mi, F	Fa, F#	Fa sharp, G	Sol, ...` | `new_note` |
| `Octave` | `choice` | `2; options: C2 to B2, C3 to B3, C4 to B4, C5 to B5` | `octave` |
| `Monotone` | `boolean` | `0` | `monotone` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "changenote.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 1, 2, 0, 1)
...
- This script calls or includes: `batch.praat`, `changepitchmedian.praat`, `preview1.inc`, `preview2.inc`.
