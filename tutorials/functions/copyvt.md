...
SCRIPT = os.path.join(TOOLKIT_DIR, "copyvt.praat")

source = parselmouth.Sound("source.wav")
target = parselmouth.Sound("target.wav")
result = praat.run_file([source, target], SCRIPT, 4, 5500, 5500, 1, 1)
...
- This script calls or includes: `changevt.praat`, `extractvowels.praat`, `preview.inc`, `workpre.praat`.
