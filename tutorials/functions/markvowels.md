# Mark vowels in a TextGrid

- Praat source: `markvowels.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `markvowels.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
SCRIPT = os.path.join(TOOLKIT_DIR, "markvowels.praat")
...
result = run_toolkit_script("markvowels.praat", "voice.wav")
```
