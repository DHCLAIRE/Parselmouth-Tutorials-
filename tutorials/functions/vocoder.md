...
| `Carrier waveform` | `optionmenu` | `1; options: Pulse train, Sawtooth, Square, Triangle, Hum, Phonation, White noise` | `carrier_waveform` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "vocoder.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 130.81, 1, 1)
...
- Vocoder and carrier/modulator pages combine several Praat objects. The `run_file` wrapper is usually the shortest faithful route.
...
- This script calls or includes: `batch.praat`, `copyvocoder.praat`, `createwaveform.praat`, `preview1.inc`, `preview2.inc`.
