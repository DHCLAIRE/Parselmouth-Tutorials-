...
| --- | --- | --- | --- |
| `Fade in (s)` | `real` | `0.05` | `fade_in` |
| `Fade out (s)` | `real` | `0 (= no change)` | `fade_out` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "fade.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 0.05, 0, 1)
