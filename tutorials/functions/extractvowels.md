...
- Praat source: `extractvowels.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `extractvowels.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
SCRIPT = os.path.join(TOOLKIT_DIR, "extractvowels.praat")
...
- This script calls or includes: `batch.praat`, `minmaxf0.praat`, `workpre.praat`.
