...
- Praat source: `pitchsmoothing.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `pitchsmoothing.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
| --- | --- | --- | --- |
| `Pitch smoothing (%)` | `real` | `50` | `pitch_smoothing` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "pitchsmoothing.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 50, 1)
