...
| --- | --- | --- | --- |
| `Delay (s)` | `positive` | `0.5` | `delay` |
| `Amplitude (Pa)` | `positive` | `0.5` | `amplitude` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "echo.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 0.5, 0.5, 1)
...
- This script calls or includes: `batch.praat`, `declip.praat`, `fixdc.praat`, `preview1.inc`, `preview2.inc`.
