# Invert pitch contour

- Praat source: `invertpitch.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `invertpitch.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
SCRIPT = os.path.join(TOOLKIT_DIR, "invertpitch.praat")
...
result = run_toolkit_script("invertpitch.praat", "voice.wav")
```
...
- This script calls or includes: `batch.praat`, `changepitchmedian.praat`.
