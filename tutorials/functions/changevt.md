# Change vocal tract size...

- Praat source: `changevt.praat`
- Tutorial type: `process`
- Selection model: one or more selected `Sound` objects

## What The Praat Script Does

- Runs the logic in `changevt.praat` from the Vocal Toolkit plugin.
- Pitch analysis.
...
| --- | --- | --- | --- |
| `Formant shift ratio` | `positive` | `1.2` | `formant_shift_ratio` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "changevt.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 1.2, 1)
...
- This script calls or includes: `batch.praat`, `minmaxf0.praat`, `preview1.inc`, `preview2.inc`, `workpost.praat`, `workpre.praat`.
