...
| --- | --- | --- | --- |
| `Breathiness (%)` | `real` | `25` | `breathiness` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "breathiness.praat")

sound = parselmouth.Sound("voice.wav")
result = praat.run_file(sound, SCRIPT, 25, 1)
...
- This script calls or includes: `batch.praat`, `copymix.praat`, `fixdc.praat`, `preview1.inc`, `preview2.inc`, `whisper.praat`.
