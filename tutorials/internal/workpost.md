...
| --- | --- | --- | --- |
| `original dur` | `real` | `0` | `original_dur` |
...
SCRIPT = os.path.join(TOOLKIT_DIR, "workpost.praat")
...
- This script calls or includes: `fixdc.praat`.
