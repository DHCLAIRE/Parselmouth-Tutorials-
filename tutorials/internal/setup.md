...
SCRIPT = os.path.join(TOOLKIT_DIR, "setup.praat")
...
result = run_toolkit_script("setup.praat", "voice.wav")
```
...
- This script calls or includes: `buttons.praat`, `updatepresetslists.praat`.
