...
- Praat source: `updatepresetslists.praat`
- Tutorial type: `helper`
- Selection model: usually called by another toolkit script

## What The Praat Script Does

- Runs the logic in `updatepresetslists.praat` from the Vocal Toolkit plugin.
...
SCRIPT = os.path.join(TOOLKIT_DIR, "updatepresetslists.praat")
...
result = run_toolkit_script("updatepresetslists.praat", "voice.wav")
```
